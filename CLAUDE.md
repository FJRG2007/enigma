...
- `compression-and-mcp.md` - the native compression engine (including the command-aware output filters behind `compress --command`) and the hand-rolled MCP server (`enigma compress`, `enigma mcp`).
