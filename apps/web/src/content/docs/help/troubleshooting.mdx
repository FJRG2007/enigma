...
`enigma issue bug` opens a prefilled GitHub issue with your environment autocompleted. See <a href={docHref("help/contributing")}>Contributing</a> for every way to reach us.
