...
Detect the project's tech stack and install the matching community skills, kept separate from the policy skills. See <a href={docHref("autoskills")}>Autoskills</a> for detail.
