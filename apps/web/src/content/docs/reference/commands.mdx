...
enigma's **native** codebase memory / code graph (structural code intelligence), exposed to your agents over MCP - no external tool. Off by default. See <a href={docHref("concepts/code-graph")}>Codebase memory</a> for detail.
