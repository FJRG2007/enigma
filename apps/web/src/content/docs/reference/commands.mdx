...
<Cmd name="enigma codegraph <status|on|off|index|projects|arch|search>" ex={["enigma config code-graph on", "enigma codegraph index", "enigma codegraph projects", "enigma codegraph arch", "enigma codegraph search Handler"]}>
