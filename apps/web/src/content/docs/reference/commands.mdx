...
Codebase memory / code graph (structural code intelligence) registered in your agents over MCP. Off by default. See <a href={docHref("concepts/code-graph")}>Codebase memory</a> for detail.
