---
title: Context menu
description: The right-click menu, with the behaviour a desktop one has - submenus that survive a diagonal pointer, shortcuts on the right, a filter when a level is long, and rows fetched on demand.
group: Forms
order: 22.8
space: components
---
