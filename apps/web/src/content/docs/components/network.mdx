...
Connection state, plus whatever the Network Information API will say about it. It lives in
utils rather than primitives because a connection is the environment, not an interaction.
...
<Frameworks>
    <div slot="react">
```tsx
import { useNetworkState } from "@enigmax/utils/react";
...
```
    ...
    <div slot="vanilla">
```js
import { createNetworkMonitor } from "@enigmax/utils";
...
<Installation item="network" pkg="@enigmax/utils" entry="@enigmax/utils/react">
    <div slot="manual">
