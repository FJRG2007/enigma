...
# lib/enigma/marquee.ts      the headless engine
# lib/enigma/use-marquee.ts  the React hook
# lib/enigma/Marquee.tsx     a styled component, utility classes, yours to edit
```
    </div>
    <div slot="css">
```sh
...
# lib/enigma/marquee.ts      the headless engine
# lib/enigma/use-marquee.ts  the React hook
# lib/enigma/Marquee.tsx     a styled component, class names, yours to edit
# lib/enigma/marquee.css     the stylesheet it imports
```
    </div>
</StyleTabs>
