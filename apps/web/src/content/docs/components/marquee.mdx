...
<Preview title="brand colours" hint="Three real marks and four obvious placeholders. Drag it - the logos stay links if you make them links.">
...
.wall-copy img { height: 26px; width: auto; opacity: .78; transition: opacity .2s; }
