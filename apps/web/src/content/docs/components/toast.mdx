...
export const tailwindRecipe = highlightedRecipe("@enigmax/utils", "toast/tailwind.tsx");
export const cssSheet = highlightedRecipe("@enigmax/utils", "toast/styles.css");

Mount it once, notify from anywhere.

```tsx
import { Toaster, useNotifications } from "@enigmax/utils/react";
import "@enigmax/utils/toast.css";
...
<Installation item="toast" pkg="@enigmax/utils" entry="@enigmax/utils/react">
    <div slot="manual">
