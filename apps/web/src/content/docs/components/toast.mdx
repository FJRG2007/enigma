...
Mount it once, notify from anywhere. There is no stylesheet to import: this is the one
component in the package that brings its own look, because a toast renders at the edge of
the screen and a forgotten import gives you a pile of text in a corner rather than something
you can see is unstyled.
...
<ToastPlayground client:only="react" />
