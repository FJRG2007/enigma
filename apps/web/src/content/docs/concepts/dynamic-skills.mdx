...
|---|---|---|
| Targets | One tool, by hand | Claude Code, Codex, opencode and Kimi Code from one source |
...
See [Configuration](/enigma/docs/reference/configuration/) for the settings that drive the re-rendering, and [Commands](/enigma/docs/reference/commands/) for `enigma skills` and `enigma install`.
