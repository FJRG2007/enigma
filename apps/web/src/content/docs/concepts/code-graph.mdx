...
<Cmd name="enigma codegraph graph [focus]" ex={["enigma codegraph graph", "enigma codegraph graph readConfig --depth 2", "enigma codegraph graph --scope files --in src", "enigma codegraph graph --dot"]}>
...
<Cmd name="enigma codegraph [action]" ex={["enigma codegraph index", "enigma codegraph ask \"where is the session token refreshed\" --source", "enigma codegraph callers readConfig --depth 2", "enigma codegraph skeleton src/api.ts", "enigma codegraph map", "enigma codegraph graph readConfig", "enigma codegraph grep \"TODO\\(perf\\)\"", "enigma codegraph check"]}>
