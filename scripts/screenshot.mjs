...
const STATUS = {
    systems: {
        ...
        outputStyle: "full", minimalCode: "full", parallelSubagents: true, autoLint: true, guardrails: { on: true, rules: 6, findings: 4 }, trim: true, verify: { on: true, command: "npm test" }, commitEmoji: true,
