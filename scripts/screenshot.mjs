...
const STATUS = {
    systems: {
        ...
        outputStyle: "full", minimalCode: "full", parallelSubagents: true, autoLint: true, guardrails: { on: true, rules: 6 }, trim: true, verify: { on: true, command: "npm test" }, commitEmoji: true,
