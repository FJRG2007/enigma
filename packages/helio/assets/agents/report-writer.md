...
## Character Rules (ASCII only — no exceptions, applies to prose AND code comments)
...
- Use -- not — (em-dash)
- Use ... not … (ellipsis)
- Use ---- not ──── or ═══ or any box-drawing character in code comments
- No emojis anywhere: not in prose, not in titles, not in code comments
- No unicode characters a developer would not type directly from a standard keyboard
- No horizontal rules (--- or ***) as visual decorators in the report body

## PoC

Every report includes a working PoC. No exceptions. For automated flows, derive from captured request/response data. No author comment in the PoC code.
...
Auth bypass -> admin (no auth): AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:H/SC:N/SI:N/SA:N = 9.3 Critical
SSRF -> cloud metadata:         AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:N/VA:N/SC:H/SI:H/SA:N = 10.0 Critical
```
