...
- **Browser automation tools** are used only for account creation and interactive flows -- all standard HTTP requests use curl/fetch
...
SKIP:    Any finding that fails Q6 (no proof beyond "technically possible")
```
